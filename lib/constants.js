export const BELTS = [
  ...
  'Black', 'Black 2nd Dan', 'Black 3rd Dan',
...
export function isSpectator(role) {
  return role === ROLES.SPECTATOR;
}
export function canManageCategories(role) {
  return isAdminOrOrganizer(role);
}
export function canManageTatamis(role) {
  return isAdminOrOrganizer(role);
}
...
export const STANDARD_WEIGHT_DIVISIONS = [
  { code: 'W30', label: 'Under 30 kg', min: 0, max: 30 },
  { code: 'W35', label: 'Under 35 kg', min: 30, max: 35 },
  { code: 'W40', label: 'Under 40 kg', min: 35, max: 40 },
  { code: 'W45', label: 'Under 45 kg', min: 40, max: 45 },
  { code: 'W50', label: 'Under 50 kg', min: 45, max: 50 },
  { code: 'W55', label: 'Under 55 kg', min: 50, max: 55 },
  { code: 'W60', label: 'Under 60 kg', min: 55, max: 60 },
  { code: 'W65', label: 'Under 65 kg', min: 60, max: 65 },
  { code: 'W70', label: 'Under 70 kg', min: 65, max: 70 },
  { code: 'W70+', label: 'Over 70 kg', min: 70, max: 150 },
];
