...
export const STANDARD_AGE_DIVISIONS = [
  { code: 'JR', label: 'Junior', min: 5, max: 17 },
  { code: 'SR', label: 'Senior', min: 18, max: 99 },
];

export const STANDARD_WEIGHT_DIVISIONS = [
  { code: 'W50', label: '40 to 50 kg', min: 40, max: 50 },
  { code: 'W60', label: '50 to 60 kg', min: 50, max: 60 },
  { code: 'W70', label: '60 to 70 kg', min: 60, max: 70 },
  { code: 'W80', label: '70 to 80 kg', min: 70, max: 80 },
  { code: 'W80+', label: 'Over 80 kg', min: 80, max: 150 },
];
