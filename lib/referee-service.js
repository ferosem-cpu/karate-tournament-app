import { addDoc, collection, doc, updateDoc, serverTimestamp, query, where, onSnapshot, getDocs, getDoc } from 'firebase/firestore';
...
export async function approveRefereeApplication(applicationId, userId) {
  ...
  // Update the user's role to referee (unless user is already a dojo_admin, super_admin, or tournament_organizer)
