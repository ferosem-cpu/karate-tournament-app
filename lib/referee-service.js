 ...
 */
export async function submitRefereeApplication(userId, fullName, martialArtsRank, beltLevel, certifications, certificateUrl = null) {
  if (!userId || !fullName || !martialArtsRank || !beltLevel) {
